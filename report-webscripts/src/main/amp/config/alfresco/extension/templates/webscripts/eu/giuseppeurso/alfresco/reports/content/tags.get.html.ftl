...
<div class="caption reportTitle">TOTAL TAGS: ${total}</div>
<div class="caption">Execution time: ${execution}</div>		
<div id="table">
	<div class="header-row row">
	 <span class="cell primary">Number</span>
     <span class="cell primary">Tag Name</span>
    </div>
<#list tags as tag>
  <div class="row">
     <span class="cell primary" data-label="Vehicle">${tag_index +1}</span>
     <span class="cell primary" data-label="Vehicle">${tag}</span>
   </div>
</#list>  
</div>
